<template>
      ...
      <div class="temp">
        <p class="display-2 font-weight-medium pt-3">God of War</p>
          ...
          <div class="affichageSyno">
            ...
            <div class="photo">
              <img src="../assets/GOW.jpg" alt="God of War">
            </div>

            <div class="text">
            <p class="title font-weight-light">
              <inline class="font-weight-bold"> Synopsis : </inline> Dans ce
              nouvel épisode de God Of War, le héros évoluera dans un monde aux
               inspirations nordiques, très forestier et montagneux. Dans ce
               beat-them-all, un enfant accompagnera le héros principal, pouvant
                apprendre des actions du joueur, et même gagner de l'expérience.</p>
            </div>
          </div>
  ...
  export default {
    data () {
      return {
        items: [
          {
            src: require('../images/GOW/gow.jpg')
          },
          {
            src: require('../images/GOW/gow2.jpg')
          },
          {
            src: require('../images/GOW/gow3.jpg')
          },
          {
            src: require('../images/GOW/gow4.jpg')
          }
        ],
        ...
        caracteristique: [
          {
            value: false,
            name: 'Editeur(s) : ',
            entre : 'Sony Computer Entertainement / Sony Santa Monica'
          },
          {
            value: false,
            name: 'Sortie : ',
    ...
    methods : {
      submitCom() {
        gow.push({commentaire : this.commentaire, name : this.name, edit: false});
        this.commentaire="";
        this.name="";
      },

      removeCom(key) {
        gow.child(key).remove();
      }
